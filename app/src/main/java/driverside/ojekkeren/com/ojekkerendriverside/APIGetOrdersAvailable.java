 ...
 */
public interface APIGetOrdersAvailable {
    @GET("/api.php")
    public void getOrdersList(@Query("task") String task, Callback<List<POJOOrdersData>> callback);

    @GET("/api.php")
    public void getOrdersByOrderIdId(@Query("task") String task,@Query("orderid") String orderid, Callback<POJOOrdersData> callback);
